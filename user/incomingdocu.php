      ...
      <table>
        <tr>
          ...
          <td class="am-display" rowspan="2" valign="top">
            <h3 class="nav-header">all incoming documents</h3>
              <div class="menu-display" style="height: 350px">
								...
								require_once '../include/config.php';
								  ...
								  mysqli_stmt_close($stmt);
									...
									$sql = "SELECT * from document LEFT JOIN recipient ON document.docu_id=recipient.docu_id WHERE recipient.status=2 AND recipient.reci_id=$id";
