          ...
          <td class="am-display" rowspan="2" valign="top">
            <h3 class="nav-header">new document</h3>
              <div class="menu-display" style="height: 450px">
								<div class="create-docu">
									<form class="form-create">

											<label>document type: </label> </br>
											<select name="office"><option> (please select:)</option>
												<option>Communication Letters</option>
												<option>Memorandum Orders</option>
												<option>Purchase Requests</option></select></br>

											<label>document name: </label></br>
											<input type="text" name="docu-name"> </br>
											<label>attach document: </label> </br>
											<input type="text" name="docu-name"><button type="button" class="btnBrowse">Browse</button></br>

											<label>send to: </label> </br>
											<select name="office"><option> (please select:)</option>
												<option>Knowledge Management Division</option>
												<option>Legal Services</option><option>Finance Division</option></select></br>

											<label>note: </label> </br>
											<textarea rows="3" cols="80" name="note" placeholder="Enter Note Here.."></textarea></br>
											<label>set deadline: </label> </br>

											<center><div class="update-in-pass">
											<input type="submit" name="btnSave" class="btnOk" value="Send" />
											<p class="btnCancel"><a href="assigneddocu.php">Cancel</a></p>
										</div></center>
									</form>
								</div>
